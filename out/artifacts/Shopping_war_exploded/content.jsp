    ...
    <section>
      ...
      <table width="800" border="1">
        <form action="update.do" method="post">
          <tr>
            <td>회원번호(자동발생)</td>
            <td><input type="text" value="${content.custNo}" name="custNo" size="20"></td>
          </tr>
          <tr>
            <td>회원성명</td>
            <td><input type="text" value="${content.custName}" name="custName" size="20"></td>
          </tr>
          <tr>
            <td>회원전화</td>
            <td><input type="text" value="${content.phone}" name="phone" size="30"></td>
          </tr>
          <tr>
            <td>회원주소</td>
            <td><input type="text" value="${content.address}" name="address" size="50"></td>
          </tr>
          <tr>
            <td>가입일자</td>
            <td><input type="text" value="${content.joinDate}" name="joinDate" size="20"></td>
          </tr>
          <tr>
            <td>고객등급[A:VIP,B:일반,C:직원]</td>
            <td><input type="text" value="${content.grade}" name="grade" size="20"></td>
          </tr>
          <tr>
            <td>도시코드</td>
            <td><input type="text" value="${content.city}" name="city" size="20"></td>
          </tr>
          <tr>
